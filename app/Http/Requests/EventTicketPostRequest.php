...
/**
 * @OA\Schema(
 *     schema="EventTicketPostRequest",
 *     required={"name", "quota", "startSale", "endSale", "session"}
 * )
 */
class EventTicketPostRequest
{
    /**
     * @OA\Property()
     * @var string
    ...
    private function map($object)
    {
        ...
        $this->price = property_exists($object, 'price') ? (int)$object->price : null;
        $this->quota = property_exists($object, 'quota') ? (int)$object->quota : null;
